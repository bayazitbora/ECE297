...
//our colours
static constexpr color OCEAN_BLUE(0xAA, 0xDA, 0xFF);
static constexpr color PLATINUM(0xE8, 0xE8, 0xE8);
static constexpr color TEA_GREEN(0xC3, 0xEC, 0xB2);
static constexpr color BANANA_MANIA(0xC3, 0xEC, 0xB2);
static constexpr color CERULEAN_BLUE(0x33, 0x57, 0xC0);
static constexpr color JADE(0x00, 0xA5, 0x68);
static constexpr color LIGHT_GREY(0xF8, 0xF8, 0xF8);
}
